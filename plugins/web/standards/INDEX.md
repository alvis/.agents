...
| Light, dark, and system color modes | `web:standards/css/`, `web:standards/design/`, and `web:standards/theming/` |
| Brand and token theming | `web:standards/theming/` plus `web:standards/css/` and `web:standards/design/` |
| Color-mode or brand token names and scope identifiers | `coding:standards/naming/` |
