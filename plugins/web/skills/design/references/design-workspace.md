...
Load every child in the ordered [`design.template.md`](design.template.md) manifest. At every main-agent save point keep these sections current; a delegated run returns the corresponding bounded delta:
