...
- [ ] **Explicit top AND bottom separator treatment** — how this variant meets its neighbors (chosen from the [Section Separator Vocabulary](../references/guardrails.md#section-separator-vocabulary)); label the treatment in small print at each boundary
...
- **Section-separator vocabulary** — the page-wide separator system: which treatments from the [Section Separator Vocabulary](../references/guardrails.md#section-separator-vocabulary) appear where, demonstrated as rendered boundary samples between the actual chosen sections
