...
| Skill | Use when |
| --- | --- |
| `web:design` | Owning the visual contract and orchestration for an interface, including progressively selected Tailwind 4.3+ transition recipes; authorized production edits route to `frontend-implementer`, followed by independent evaluation. |
