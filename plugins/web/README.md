...
| Skill | Use when |
| --- | --- |
| `web:design` | Owning the visual contract and orchestration for an interface, including Tailwind 4.3+ transition recipes expressed as markup, CSS, and framework behavior requirements; authorized production edits route to `frontend-implementer`, followed by independent evaluation. |
