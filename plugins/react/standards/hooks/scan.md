...
- DO NOT omit any external value read inside `useEffect`/`useCallback`/`useMemo` from its dependency array, including when the array already contains other dependencies [`RH-DEPS-01`]
