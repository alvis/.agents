...
8. Return explicit final paths generated or materially rewritten as `generated_files`, plus main-agent reconciliation. Do not run file sizing; after all writers finish, the main agent checks only eligible work Markdown inside the target `.state/`.
