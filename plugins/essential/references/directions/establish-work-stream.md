...
Never broaden an existing stream beyond its confirmed goal or requirements to avoid creating a new identity. Follow [naming.md](../naming.md) for work-ID and collision rules.
...
[state.md](../state.md) owns resolution and lifecycle semantics; [lease.md](../lease.md) owns the lease-verified invocation and no-clobber mechanics.
