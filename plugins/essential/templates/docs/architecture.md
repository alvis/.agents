...
<!-- The ADR table is an index of effective records only. List every ADR directly under decisions/<domain>/ and never list anything under decisions/<domain>/superseded/. Read `${ESSENTIAL_ROOT}/references/adr.md` and use `${ESSENTIAL_ROOT}/templates/docs/adr.md` when creating or superseding an ADR. -->
