...
- The cold-start release gate in `directions/functional-mode.md` applies to every
...
4. For create, operational update, and functional or full verification, resolve the
   ...
   `directions/functional-mode.md`. Structural-only verification skips execution and
...
5. For functional or full mode, derive a transient representative-case matrix
   ...
   `${TMPDIR:-/tmp}/check.md`). Follow `directions/functional-mode.md`
