...
Record findings, review reasoning, limitations, trust caps, authorization evidence, and the substantive verdict in the structured assessment accepted by [review-publication.ts](../scripts/review-publication.ts). That executable is the only renderer and publication contract. Use the size standard to choose reading order and reviewer slots, never to suppress a finding.
