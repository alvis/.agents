...
- [size-thresholds.json](../../skills/pr/assets/size-thresholds.json) is the sole numeric PR-size authority.
- [classify-pr-size.ts](../../skills/pr/scripts/classify-pr-size.ts) scans an exact committed base/head diff for size.
- [scan-pr-message.ts](../../skills/pr/scripts/scan-pr-message.ts) scans a rendered PR body against its selected template, exact revision, and conditional evidence.
