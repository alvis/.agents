...
| Applies to | Standard |
| --- | --- |
| All implementation work, tests, and technical documentation | `coding:standards/universal/` |
...
| Comments, JSDoc, technical documentation, and exported types/APIs requiring documentation | `coding:standards/documentation/` |
