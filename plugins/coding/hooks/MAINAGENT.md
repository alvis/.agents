...
Read `{{PLUGIN_DIR}}/directions/WORKFLOW.md` before writing, reviewing, or publishing code; it owns risk tiers and routes the selected operation. Before delegating, read `{{PLUGIN_DIR}}/references/ROUTING.md` and route to the best specialist.
