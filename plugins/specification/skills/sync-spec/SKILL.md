...
10. Return every final path created or materially rewritten as `generated_files`. Each writer follows `essential:references/output-manifest.md` for work Markdown it creates or rewrites. The main agent applies the `goal.md`/`state.md` reconciliation delta.
