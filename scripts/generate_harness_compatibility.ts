...
const CROSS_CUTTING_FEATURES: readonly Feature[] = [
  feature(
    ...
    ADAPTED,
    ADAPTED,
    "Grok reads Claude-compatible plugins; OpenCode uses `scripts/install_opencode.ts`.",
  ),
  feature(
    "Marketplace catalog",
    FULL,
...
Claude Code and Codex are native targets. Grok Build consumes the Claude-compatible projection documented by xAI. OpenCode support targets stable V1 through \`scripts/install_opencode.ts\`; OpenCode V2 and \`opencode2\` are unsupported.
